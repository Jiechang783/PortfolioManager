   ...
   public class StockDao
    {
        ...
        public static int deleteStocks(Stock b)
        {
            ...
            {
                var Stock = context.Stocks.FirstOrDefault(row => row.SectorId == b.StockId);
                if (Stock != null)
                {
        ...
        public static List<Stock> getStockListBySector(Sector sector)
        {
            using (DatabaseContext db = new DatabaseContext())
            {
                ...
                {  //默认数据补全为0                   
                    ...
                    var joinStock = db.Stocks.Join(db.Sectors, a => a.SectorId, g => g.SectorId, (a, g) => new { a.StockId,a.Name,a.Isin,a.LastSale,a.MarketCap, a.IPOyear,a.SectorId,a.IndustryId,a.SummaryQuote,a.Address}).ToList();
        ...
        public static List<Stock> getStockListByIndustry(Industry industry)
        {
            using (DatabaseContext db = new DatabaseContext())
            {
                ...
                {
                    var joinStock = db.Stocks.Join(db.Industrys, a => a.IndustryId, g => g.IndustryId, (a, g) => new { a.StockId, a.Name, a.Isin, a.LastSale, a.MarketCap, a.IPOyear, a.SectorId, a.IndustryId, a.SummaryQuote, a.Address }).ToList();
        ...
        public static int updateStocks(Stock w)
        {
            ...
            Stock us = db.Stocks.Single(x => x.StockId == w.StockId);
            if (us == null)
